...
```{r}
# This function constructs a pointwise CI for the true CDF at a given value of x. A Clopper-Pearson CI is used.
get.cdf_pointwise_conf_int_LB = function(n, my_ecdf, x){
...
ggplot() +
  xlim(q80-1,q80+1) + 
  ylim(0.7,0.925) +
  stat_function(fun = get.cdf_pointwise_conf_int_LB,
                args = list(n = num_claims, my_ecdf = total_loss_ecdf))
```
